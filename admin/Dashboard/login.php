...
require_once "../Dashboard/login_val.php";
?>
<!doctype html>
<html lang="en">
...
<body class="account-pages">
    ...
    <div class="wrapper-page account-page-full">
                    ...
                    <div class="card-box p-5">
                        ...
                        <div class="row m-t-50">
                            <div class="col-sm-12 text-center">
                                <p class="text-muted">Don't have an account? <a href="../Dashboard/register.php" class="text-dark m-l-5"><b>Sign Up</b></a></p>
                            </div>
                        </div>
        ...
        <div class="m-t-40 text-center">
            <p class="account-copyright"><?= date('Y') ?> © wamdha</p>
        </div>
    </div>
