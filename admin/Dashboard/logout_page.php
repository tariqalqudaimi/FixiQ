    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-full">
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="../Dashboard/index.php" class="text-success">
                            ...
                            <div class="text-center m-b-20">
                                ...
                                <p class="text-muted font-14 m-t-10"> You are now successfully sign out. Back to <a href="../Dashboard/login.php" class="text-dark m-r-5"><b>Sign In</b></a></p>
                            </div>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">2025 © Highdmin. - waamdhatech.com</p>
            </div>
